...
summary = "This is a Photoshop-style color choosing dialog.\n"+
...
"<p>This is one of the most popular subprojects here: it's a more sophisticated "+
		"alternative to the <code>JColorChooser</code>.\n"+
		"The controls should be self-explanatory: try clicking the color wheel, color slider, "+
		"and all the controls on the left.",
link = "http://javagraphics.blogspot.com/2007/04/jcolorchooser-making-alternative.html",
sandboxDemo = true
)
